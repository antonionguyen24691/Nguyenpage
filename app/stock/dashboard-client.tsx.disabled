...
import { type AlertCondition, type AlertStatus, type Prisma } from "@prisma/client";
...
type Watchlist = Prisma.WatchlistGetPayload<{
  include: { items: true };
}>;
...
type Webhook = Prisma.WebhookGetPayload<{}>;
